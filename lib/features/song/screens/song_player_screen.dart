  ...
  Widget _buildActionButtons(bool isOwner) {
    return Wrap(
      ...
      children: [
        ...
        // Karaoke button visible ONLY for song owner
        if (isOwner)
          _ActionButton(
            ...
            onTap: () {
              ...
              if (_hasLyrics) {
                // Already converted → go to karaoke player
                _startKaraokeConversion(context, widget.song);
              } else {
                // Not yet converted → show convert popup
                _showConvertToKaraokeDialog(context, widget.song);
              }
            },
            // Show edit icon only when lyrics are ready
            showEditIcon: _hasLyrics,
            onEditTap: _hasLyrics
